...
export class ModalService {
  ...
  //region Modal
  showModal(page: any, enableBackdropDismiss: boolean, params?: any[]): Promise<any> {
    return new Promise((resolve, reject) => {
      let modal = this.modalCtrl.create(page, {params}, {enableBackdropDismiss: enableBackdropDismiss});
